...
[Transaction Cashier] Inputted Correct Transaction Details - Add
    Add Transaction From Home
    Input Name    Gausauline
    Input Number  09175442636
    Input Date    01    02    2022
    ...
    Page Should Contain   02/01/2022
    Page Should Contain   Gausauline

    Click Element   link:Home
    Wait Until Ajax Complete

[Transaction Cashier] Fuel Quantity is Above Limit - Add
    Add Transaction From Home
    Input Name    Roulx Kard
...
[Transaction Cashier] Phone Number is not 10 digits - Add
    Add Transaction From Home
    Input Name    Caltron
    Input Number  03
...
[Transaction Cashier] User attempts to Input incorrect data - Add
    Add Transaction From Home
    Input Name    Caltron
    Input Number  abc
    Input Date    01    12    2022
...
[Transaction Cashier] Inputted Correct Transaction Details - Edit
    Edit Second Transaction From Home
    Input Name Edit    Paltex
...
[Transaction Cashier] Fuel Quantity is Above Limit - Edit
    Edit Second Transaction From Home
